...
export default class HPBH extends Component {
  constructor(props){
    super(props)
    this.state={
      geo:'',
 ...
 try{   
    let options = {
      ...
      <body>
      <div style="margin-left:15%;text-align:'right'"><b>(VERIFICATION) HPBH FACILITY FORM</b></div>
      <div><b>General</b></div>
  ...
  <table style="width:90%">
      ...
      <tbody>
          ...
          <tr>
           ...
           <tr>
              <td>24</td><td>Water quality analysis carried out by the contractor? </td>
              <td>${this.state.watera}</td>
           </tr>
           <tr>
              <td>25</td><td>Color (sight water/ask beneficiaries)</td><td>${this.state.color}</td>
           </tr>
           <tr>
              <td>26</td><td>Taste (taste</td><td>${this.state.taste}</td>
           </tr>
           <tr>
              <td>27</td><td>Odour (smell water/ask beneficiaries)</td><td>${this.state.odour}</td>
           </tr>
           <tr>
              <td>28</td><td>Diameter of platform</td><td>${this.state.platformd}</td>
           </tr>
           <tr>
              <td>29</td><td>Standard  shutter used for platform</td><td>${this.state.shutter}</td>
           </tr>
           <tr>
              <td>30</td><td>Platform structually stable? (foundation with reinforcement)</td>
              <td>${this.state.stability}</td>
           </tr>
           <tr>
              <td>31</td><td>Soak pit</td><td>${this.state.soakpit}</td>
           </tr>
           <tr>
              <td>32</td><td>Signpost installed</td><td>${this.state.signpost}</td>
           </tr>
    <tr>
      <td></td><td><b>Capture</b></td><td><b>Details</b></td>
   </tr>
   <tr>
      <td>33</td><td>Cordinate</td><td>${this.state.cordinate}</td>
   </tr>
   <tr>
      <td>34</td><td>Picture 1 (site Overview)</td><td><img width="100" height="100" src='${this.state.pic1}'></img></td>
   </tr>
   <tr>
      <td></td><td>Picture 2 (capture platform tith water running)</td><td><img width="100" height="100" src='${this.state.pic2}'></img></td>
   </tr>
   <tr>
      <td></td><td>Picture 3(Signpost)</td><td><img width="100" height="100" src='${this.state.pic3}'></img></td>
   </tr>
  </tbody>
  </table>
  ...
  render() {
    ...
    return(
      ...
      <View>
        ...
        initial={-1}
        animation={true}
        onPress={(value)=>{this.setState({pumpt:value})}}
        /> 
        ...
        /> 
          <Text>Diameter of platform</Text>
          <TextInput style={styles.box} onChangeText={(value)=>{this.setState({platformd:value})}}/>

          <Text>Standard shutter used for platform?</Text>
               <RadioForm 
        radio_props={radio_props}
        formHorizontal={true}
        labelHorizontal={false}
        initial={-1}
        animation={true}
        onPress={(value)=>{this.setState({shutter:value})}}
        />
              <Text>Platform structually stable? (foundation with reinforcement)</Text>
               <RadioForm 
        radio_props={radio_props}
        formHorizontal={true}
        labelHorizontal={false}
...
<Button style={{marginBottom:40}}  onPress={this._takePhoto}   title="Capture site overview" />
</View>
<View style={{marginBottom:20}}>
 <Button  style={{marginTo:4}}  onPress={this._takePhoto2}  title="Capture platform with water running"/>
  </View>
 <View style={{marginBottom:20}}>
     <Button    onPress={this._takePhoto3}   title="Capture signpost" />
</View>
