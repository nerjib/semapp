...
<TouchableOpacity style={styles.row} onPress={()=>{navigation.navigate('HPBH Lesson 1')}}>

<Text style={styles.txt}>Lessson 1: Taking over site/ Geophysical Survey</Text>
</TouchableOpacity>
<FlatListSeparator/>

<TouchableOpacity style={styles.row} onPress={()=>{alert('You must finish lesson 1 to unlock lesson 2')}}>
<Text style={styles.txt}>Lesson 2: Drilling</Text>
</TouchableOpacity>
<FlatListSeparator/>

<TouchableOpacity style={styles.row} onPress={()=>{alert('You must finish lesson 2 to unlock lesson 3')}}>

<Text style={styles.txt}>Lesson 3: Pump testing</Text>
</TouchableOpacity>
<FlatListSeparator/>

<TouchableOpacity style={styles.row} onPress={()=>{alert('You must finish lesson 3 to unlock lesson 4')}}>

<Text style={styles.txt}>Lesson 4: Pump installation and platforming</Text>
</TouchableOpacity>
<FlatListSeparator/>


{ <TouchableOpacity style={styles.row} onPress={()=>{alert('You must finish lesson 4 to unlock lesson 5')}}>
<Text style={styles.txt}>Lesson 5: Site handing over</Text>
</TouchableOpacity>}
<FlatListSeparator/>
