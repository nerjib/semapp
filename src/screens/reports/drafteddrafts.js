...
export default class DraftedDraft extends React.Component{
    constructor(props){
        super(props)
        this.state={
            tableview:'none',
            ...
            imgurl3:'',
            gentime:'',
            imguri:'',imguri2:'',gps:'',imgurl:'',area:'',contact2:'',
            comment:'',lga:'',cause:'',ward:'',place:'',event:'',causedescri:''
...
//    imguri,imguri2,gps,imgurl,area,contact2,comment,lga,cause,ward,place,event,causedescri

Object.keys(this.state.receivedData).map((e,i)=>data2.push([this.state.receivedData[e].event,this.state.receivedData[e].area+' '+this.state.receivedData[e].lga,this.state.receivedData[e].cause,
    <Image onPress={()=>this.handleGo('f')}
    source={{ uri: this.state.receivedData[e].imguri }}
...
handleGo1=async e=>{
    const {     imguri,imguri2,gps,imgurl,area,contact2,comment,lga,cause,ward,place,event,causedescri
    } = this.state.receivedData[e];
...
handlesend1=()=>{
  //  AsyncStorage.removeItem('MonRep1')
    ...
    let    newData=JSON.stringify(oldData)
    //alert(newData)
    AsyncStorage.setItem('DraftReport',newData)
        //alert(newData)
    })
